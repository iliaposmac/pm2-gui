...
const { collectStatsCron } = require("./cron/collect-stats");
...
const { getAppMetrics } = require("./utils/read-logs.util");
...
setInterval(async () => {
  console.log(`Application cron extracted data`);
  await collectStatsCron();
}, 2500);
